...
public class DesignTacoController {
    ...
    /**
     * Метод addIngredientsToModel() извлекает все ингредиенты из базы данных, вызывая метод findAll() внедренного
     * экземпляра IngredientRepository. Затем он фильтрует их по типам ингредиентов и добавляет в модель.
     * @param model
     */
    @ModelAttribute
